 ...
 * 上传/更新巡检记录信息
 */
public class UpLoadRepInPresenterImpl extends BasePresenterImpl implements ICommitPresenter<InStockDetail.DataBean> {
     ...
     */
    @Override
    public void uploadData(InStockDetail.DataBean information) {
